...
const MarkdownQueryBlock: React.FC<MarkdownQueryBlockProps> = ({
  ...
  return (
    <div
      className={`rounded-lg bg-muted border border-border p-4 text-[13px] leading-relaxed text-foreground/90 font-medium shadow-sm flex items-center justify-start ${className || ""}`}
