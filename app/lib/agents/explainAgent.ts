...
DO NOT MISS COLUMNS YOU MUST INCLUDE EVERYTHING THE USER SHOULD BE ADDING INTO AN INSERTION. Ensure all information comes from the database itself and its schema. Do not generate or assume column names or types.  
`;
